...
def convertConversionCodeSingle(args):
    ...
    conversionCode = int(args.conversioncode)
    isReferenceFlag = conversionCode & 1
    hasAnchorFlag = conversionCode & 2
    lengthFlag = conversionCode & 4
    lengthMatchFlag = conversionCode & 8
    hasMultipleAnchorsFlag = conversionCode & 16
    isQueryFlag = conversionCode & 32
    generalErrorFlag = conversionCode & 64
    # print header line
